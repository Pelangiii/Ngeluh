            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Leon keneddy</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">Add complaint form</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-success">Enter the requested data!</h6>
                                </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="lable-control" for="username">Complaint description</label>
                                            <textarea name="message" class="form-control" placeholder="Silahkan Masukan Laporan anda"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="lable-control" for="password">Photo evidence</label>
